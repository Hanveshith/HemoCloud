        ...
        <div className="dark:text-white-900">
            ...
            <div className='grid grid-cols-2 place-items-center mt-6 px-52'>
                ...
                <div>
                    ...
                    The Heartbeat <br />of <br /> Life-Saving Connections
                    </p>
                </div>
            </div>
            ...
            <div className='grid grid-cols-2 place-items-center'>
                {temp2.map((e, i) =>
                    <div className='border-metal shadow-md rounded-lg m-2 overflow-hidden max-w-[90%] select-none grid grid-cols-2'>
                        <div><img src={e.img} draggable={false} width="100%" alt="" /></div>
                        <div className='m-4'>
                            {/* align center both horizontally and verticallly*/}
                            <p className='text-center mt-8 font-bold text-lg text-blood'>{e.title}</p>
                        </div>
                    </div>
                )}
            </div>
            ...
            <div className='w-full bg-blood text-white-900 h-max text-sm text-center font-bold'>
                <code>HemoCloud @ {new Date().getFullYear()}|| Made with ❤️ </code>
            </div>
        </div>
    )
}
